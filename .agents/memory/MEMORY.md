...
- [EVM Network Fee Model (Polygon testnet)](evm-network-fee.md) — flat fee separata da projectFee; TX2=projectFee+networkFeeCharged; vi.mock("viem") obbligatorio nei test che coprono _releaseEvm
