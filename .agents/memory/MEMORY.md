...
- [Sprint 28 — Shared Identity Key](sprint-28-shared-ik.md) — IK condivisa via blob AES-GCM sul server; Fase 1 server completata; feature flag SIGNAL_IK_CONSISTENCY_CHECK
