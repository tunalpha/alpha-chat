...
const VERIFIED_TOKENS: VerifiedToken[] = [
  ...
  // Previous address (0x23396cF..., 39 hex chars) returned "Invalid Token" on PolygonScan — was a placeholder.
  { chainId: 137, symbol: "USDA", name: "USD Alpha",     decimals: 18, contractAddress: "0xe714655fd1b3ba96b887df1f94336c2a78e24001" },
