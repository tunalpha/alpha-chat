  ...
  return (
    <section>
      <div className="text-center mb-16 space-y-4">
        <h2 className="text-4xl md:text-5xl font-serif text-foreground">{dict.ecosystem.title}</h2>
      ...
      <div className="mt-16 relative">
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-between gap-4 md:gap-2">
          ...
          <div className="flex-1 w-full bg-muted/20 border border-border p-6 rounded-2xl text-center relative z-10">
            ...
            <div className="text-sm font-medium text-foreground">{dict.ecosystem.labels.user}</div>
          </div>
          ...
          <div className="flex-1 w-full bg-primary/20 border border-primary/50 p-6 rounded-2xl text-center relative z-10 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
            ...
            <div className="text-sm font-medium text-primary font-semibold">{dict.ecosystem.labels.alphaChat}</div>
          </div>
          ...
          <div className="flex-1 w-full bg-muted/20 border border-border p-6 rounded-2xl text-center relative z-10">
            <div className="w-12 h-12 rounded-full bg-muted/40 flex items-center justify-center mx-auto mb-3">
              <span className="font-serif font-bold text-foreground">$$</span>
            </div>
            <div className="text-sm font-medium text-foreground">{dict.ecosystem.labels.usda}</div>
          </div>
          ...
          <div className="flex-1 w-full bg-muted/20 border border-border p-6 rounded-2xl text-center relative z-10">
            ...
            <div className="text-sm font-medium text-foreground">{dict.ecosystem.labels.alphaBitPay}</div>
          </div>
          ...
          <div className="flex-1 w-full bg-muted/20 border border-border p-6 rounded-2xl text-center relative z-10">
            ...
            <div className="text-sm font-medium text-foreground">{dict.ecosystem.labels.merchants}</div>
          </div>
