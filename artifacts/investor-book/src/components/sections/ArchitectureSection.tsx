...
export default function ArchitectureSection({ dict }: { dict: any }) {
  return (
    <section>
      ...
      <div className="bg-background/80 border border-white/10 rounded-3xl p-8 md:p-12 relative overflow-hidden">
        {/* Decorative Grid */}
        ...
        <div className="relative z-10 flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="w-full md:w-64 bg-white/5 border border-white/10 rounded-xl p-6 text-center backdrop-blur-md">
              <div className="text-white font-medium mb-1">{dict.architecture.labels.clients}</div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div className="w-full md:w-72 bg-white/5 border border-white/10 rounded-xl p-6 text-center backdrop-blur-md">
              <div className="text-white font-medium mb-1">{dict.architecture.labels.backend}</div>
            ...
            <div className="w-full md:w-72 bg-white/5 border border-white/10 rounded-xl p-6 text-center backdrop-blur-md">
              <div className="text-white font-medium mb-1">{dict.architecture.labels.db}</div>
